...
@section('content')
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 bg-pink-50">
        <div class="pointer-events-none absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]" aria-hidden="true">
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-600">Pour toutes questions, veuillez entrer vos informations</p>
        </div>
