...
@section('content')
    ...
    <h2>Déposez un commentaire</h2>
        ...
        <form>
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <p class="mt-1 text-sm leading-6 text-gray-600">Laissez donc un commentaire sur ce poste.</p>
                        ...
                        <div class="col-span-full">
                            <label for="about" class="block text-sm font-medium leading-6 text-gray-900">Votre commentaire</label>
                            <div class="mt-2">
            ...
            <br>
            <label for="about" class="text-center block text-lg font-medium leading-6 text-gray-900 py-16">Le nombre de commentaire est : {{count($post->comments)}}</label><br>
            <section class="bg-white dark:bg-gray-900 py-8 lg:py-16">
                <div class="max-w-2xl mx-auto px-4">
                        ...
                        <footer class="flex justify-between items-center mb-2">
                            <div class="flex items-center">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-03-12"
                                                                                          title="March 12th, 2022">Crée le {{$comment->created_at->format('d/m/Y')}}</time></p>
                            </div>
                    ...
                    <label for="about" class="text-center block text-lg font-medium leading-6 text-gray-900">Le nombre de tag est : {{count($post->tags)}}</label><br>
